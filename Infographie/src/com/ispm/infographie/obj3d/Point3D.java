...
public class Point3D extends Point {
    ...
    public Point3D(float xR, float yR, float zR, char type, Color c) {
        super(xR, yR, type, c);
    ...
    public Point3D rotateX(double alpha) {
        ...
        return new Point3D(super.getxR(), yprime, zprime, this.type, this.color);
    }
    ...
    public Point3D rotateY(double alpha) {
        ...
        return new Point3D(xprime, super.getyR(), zprime, this.type, this.color);
    }
    ...
    public Point3D rotateZ(double alpha) {
        ...
        return new Point3D(xprime, yprime, z, this.type, this.color);
    }

    public Point3D translate(int x, int y, int z) {
        return new Point3D(super.getxR() + x, super.getyR() + y, z, type, color);
    }
